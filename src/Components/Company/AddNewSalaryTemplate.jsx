...
const AddNewSalaryTemplate = () => {
  return (
    <div>
      <h2 className="text-lg md:text-lg text-gray-500 font-semibold mb-4">New Salary Template</h2>
  ...
  <div className="flex items-center bais-2/3">
    ...
    <span className="ml-2 text-gray-600">per year</span>
      ...
      <div className="flex items-center p-4">
        ...
        <button className="flex items-center justify-center ml-4 w-1/9 border border-gray-300 text-gray-900 px-5 py-1 md:px-4 md:py-2 text-xs md:text-sm rounded-full font-semibold cursor-pointer hover:bg-gray-300">
          Cancel
        </button>
      </div>
    </div>
